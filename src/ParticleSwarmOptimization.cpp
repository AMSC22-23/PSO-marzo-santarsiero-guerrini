...
ParticleSwarmOptimization::ParticleSwarmOptimization(std::function<double(std::vector<double>)> fitness_function, int n, int dim, int lower_bound, int upper_bound, int max_iter, double tolerance,
