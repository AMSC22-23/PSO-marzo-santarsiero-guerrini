...
int main(int /*argc*/, char** /*argv*/) {
	...
	ParticleSwarmOptimization<dimension> pso(TestFunctions::sphere<dimension>, 50, 100000, bounds.first, bounds.second, 10e-6, 0.4, 0.9, 2.0);
	pso.initialize();
	...
	std::cout << std::endl;
	ParticleSwarmOptimization<dimension> pso1(TestFunctions::sphere<dimension>, 50, 100000, bounds.first, bounds.second, 10e-6, 0.4, 0.9, 2.0);
	pso1.initialize();
